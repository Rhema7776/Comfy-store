    ...
    <div className="grid lg:grid-cols-2 gap-24 items-center">
      <div>
        ...
        <p className="mt-8 max-w-xl text-lg leading-8">
          ...
          dolores ipsum. At eveniet debitis aspernatur amet sint. Vero
          dignissimos dolorum necessitatibus quisquam tempore reiciendis porro
          quibusdam corporis a unde!
        </p>
        <div className="mt-10">
